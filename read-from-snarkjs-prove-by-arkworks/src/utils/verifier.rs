...
use crate::utils::data_structures::{PreparedVerifyingKey, Proof, VerifyingKey};

// pub use self::data_structures::*;
// use super::{PreparedVerifyingKey, Proof, VerifyingKey};

// use ark_relations::r1cs::{Result as Result, SynthesisError};
...
pub fn prepare_inputs<E: PairingEngine>(
    ...
    public_inputs: &[E::Fr],
) -> Result<E::G1Projective, &'static str> {
    if (public_inputs.len() + 1) != pvk.vk.gamma_abc_g1.len() {
        return Err("MalformedVerifyingKey");
    }
...
pub fn verify_proof_with_prepared_inputs<E: PairingEngine>(
    ...
    let test = E::final_exponentiation(&qap).ok_or("UnexpectedIdentity")?;
